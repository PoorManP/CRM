    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal" id="addbtn">保存</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="edit-statu">
                                <option></option>
                                <option>试图联系</option>
                                <option>将来联系</option>
...
<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div cla6ss="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">

                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">名称
                        </div>
