...
<script type="text/javascript">
	...
	//	搜索市场活动
		...
		$("#submitActivityBtn").click(function () {
			var $input = $("input[name=xz]:checked");
			var id = $input.val();
			var name = $("#" + id).html();
			// alert(name + id
			// );
...
<%--		window.location.href="clue/convert.do?id=${param.id}"--%>


		<form id="transform" action="clue/convert.do" method="get">
<%--			标记是滞创建交易--%>
<%--		flag	clueId  money  name  expectedDate  staga  activityId--%>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <select id="stage"  class="form-control" name="staga">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchModelBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
		    <input type="text" id="activityName"  class="form-control"  placeholder="点击上面搜索" readonly>
