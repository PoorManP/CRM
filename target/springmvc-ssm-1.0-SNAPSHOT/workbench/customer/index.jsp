...
/*		$("#modifyBtn").click(function () {
		...
		// address create-nextContactTime  create-contactSummary create-description create-phone
		// create-website create-customerName create-customerOwner
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.dataList,function (i,n) {
					html += '<tr>'
					html += '<td><input type="checkbox" id="'+n.id+'" name="dx"/></td>'
